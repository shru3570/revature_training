...
public class Demo1 {
	...
	public static void main(String []args)
	{
		...
		//System.out.println("s4  = "+s1+"s1 memory is"+System.identityHashCode(s1));
		s3=s3.intern();//bring the object back to the common pool
		System.out.println("s3  = "+s3+" s3 memory is  "+System.identityHashCode(s3));
		...
		{
			System.out.println("char at:("+i+") is : "+s3.charAt(i));
		}
		...
		System.out.println("s3.substring(1): "+s3.substring(1,4));
