...
public class String_Task {
	...
	public static void main(String[] args) {
		...
		String s="Helloo it is revature WoW";
		System.out.println("Task1 : "+makeLastCharUpperCase(s));
		System.out.println("Task 2 :"+makeMiddleOFirstCharUppercase(s));
		System.out.println("Task 3 : "+reversePalindrome(s));
...
//	================================================================================
	public static StringBuilder makeMiddleOFirstCharUppercase(String s)
	{
		StringBuilder sb=new StringBuilder();
		String str[]=s.split(" ");
		for (int i = 0; i < str.length; i++) {
